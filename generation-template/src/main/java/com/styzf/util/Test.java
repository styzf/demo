...
public class Test {
    ...
    public static void main(String[] args) {
        Test jCallGraph = new Test();
        args = new String[]{"D:\\dev\\apache-maven-yzf-3.5.0\\repository\\com\\baomidou\\mybatis-plus-core\\3.4.2\\mybatis-plus-core-3.4.2.jar"};
        jCallGraph.run(args);
    }
    ...
    public void run(String[] args) {
        ...
        String outputFilePath = "D:\\test\\mybatis";
